    ...
    sAnimation.registry.js_attribute_filter_price = sAnimation.Class.extend({
        ...
        _getSliderOptions: function () {
            ...
            return _.extend({
                ...
                keyboard: true,
                min: 0,
                max: this.$price_slider.data("max_price_price"),
                from: this.$price_slider.data("custom_min_price_price"),
                to: this.$price_slider.data("custom_max_price_price"),
        ...
        _onChangeMaxValue: function (ev) {
            ...
            var ionRange = this.$price_slider.data("ionRangeSlider");
            ionRange.update({
                to: $(ev.target).val() || this.$price_slider.data("max_price_price")
            });
        },
